...
import { Calendar, Clock, ArrowRight, Pin, Search } from 'lucide-react';
...
const ActualitesPage = () => {
  ...
  const categories = ['all', ...new Set(mockNews.map(article => article.category))];
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div>
            <h2 className="text-2xl font-bold text-white mb-8">
              Tous les articles ({regularArticles.length})
            </h2>
